# -*- coding: utf-8 -*-
"""
Created on Wed Jan 21 00:15:20 2026
...
def cancerPrediction():
    ...
    if predict == 1:
      ...
      output2 = f"Confidence: {round(proba*100)}%"
    else:
    ...
    return render_template('home.html', output1=output1, output2=output2, 
                           ...
                           query3=request.form['query3'], query4=request.form['query4'], query5=request.form['query5'])
